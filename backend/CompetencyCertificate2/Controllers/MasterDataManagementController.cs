    ...
    public class UserController : ControllerBase
    {
        ...
        public IActionResult Login([FromBody] LoginDto loginDto)
        {
            try
            {
                ...
                // Try executive login
                var login = _context.EmployeeLogin.FirstOrDefault(e => e.employee_id == loginDto.EmployeeId);
                ...
                // Try HR login
                var hrLogin = _context.HRLogin.FirstOrDefault(e => e.employee_id == loginDto.EmployeeId);
                if (hrLogin != null && BCrypt.Net.BCrypt.Verify(loginDto.Password, hrLogin.Password))
                {
        ...
        public IActionResult GetSubDepartmentByName(string subdept)
        {
            ...
            if (sub == null)
            {
                return NotFound(new { message = "Subdepartment Not Found " });
            }
            return Ok(sub);
        }
